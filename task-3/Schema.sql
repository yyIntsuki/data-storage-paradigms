...
CREATE TABLE lesson_type_info (
    lesson_type VARCHAR(59) NOT NULL UNIQUE,
    price INT NOT NULL,
    min_allowed INT NOT NULL,
    max_allowed INT NOT NULL
);

ALTER TABLE lesson_type_info ADD CONSTRAINT PK_lesson_type_info PRIMARY KEY (lesson_type);
...
ALTER TABLE lesson ADD CONSTRAINT FK_lesson_type_info_lesson FOREIGN KEY (lesson_type) REFERENCES lesson_type_info (lesson_type);
